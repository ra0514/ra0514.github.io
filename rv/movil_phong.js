...
this.canon=new THREE.Mesh(new THREE.BoxGeometry(4,4,1),new THREE.MeshPhongMaterial({color:'#00cc00'}));
this.sujetador=new THREE.Mesh(new THREE.BoxGeometry(1,6,1),new THREE.MeshPhongMaterial({color:'#00cc00'}));
